    ...
    return (
        <div className="text-center py-10 px-5">
            ...
            >
                ...
                <div
                    className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 ${fadeIn ? 'opacity-100' : 'opacity-0'}
                        transition-opacity duration-1500`}
                >
                    <div
                        className={`bg-[#DDA15E] p-6 rounded-lg shadow-lg  transition-transform duration-300 transform ${cardsHovered[0] ? 'scale-105' : 'scale-100'}`}
                        onMouseEnter={() => handleHover(0)}
                        onMouseLeave={() => handleMouseOut(0)}
                    >
                        <img src={img1} className='rounded-lg mb-2 w-full h-52' alt="" />
                    ...
                    <div
                        className={`bg-[#DDA15E] p-6 rounded-lg shadow-lg  transition-transform duration-300 transform ${cardsHovered[1] ? 'scale-105' : 'scale-100'}`}
                    ...
                    <div
                        className={`bg-[#DDA15E] p-6 rounded-lg shadow-lg  transition-transform duration-300 transform ${cardsHovered[2] ? 'scale-105' : 'scale-100'}`}
                        onMouseEnter={() => handleHover(2)}
                        onMouseLeave={() => handleMouseOut(2)}
                    >
                        <img src={img3} className='rounded-lg mb-2 h-52 w-full' alt="" />
