        ...
        <footer className="footer footer-center bg-black text-white rounded p-10">
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href='https://www.linkedin.com/in/imtiaz-ahmed-ar/' target='_blank'>
                    ...
                    <a href="https://github.com/ImtiazAhmed01" target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 50 50" className="fill-current">
                    ...
                    <a href='https://www.facebook.com/imtiaz.ahmedar' target='_blank'>
                        <svg
